...
- ソーシャルゲーム開発の本のサンプル改造
  - [この書籍](https://www.amazon.co.jp/dp/B083Z2Z6PH/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1)のサンプルを色々改造してみている。
  - 書籍のサンプルを扱うのでプライベートリポジトリ
  - 「サーバ側のソースがFat Controllerなのでリファクタリング必須か？」という事で折れるかも
    - 書籍のサンプルなので仕方がないのかも知れないが
- アクションゲーム開発
  - リハビリ兼ねてまったりと
